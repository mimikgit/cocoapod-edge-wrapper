...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="edgeSDK_iOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11edgeSDK_iOS10EdgeConfig")
@interface EdgeConfig : NSObject
...
@property (nonatomic, readonly, copy) NSString * _Null_unspecified workingDirectory;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end

enum MMKSubSystem : NSInteger;
enum MMKLogLevel : NSInteger;
...
SWIFT_CLASS("_TtC11edgeSDK_iOS6MMKLog")
@interface MMKLog : NSObject
...
///
+ (enum MMKLogLevel)selectedLoggingLevelWithSubsystem:(enum MMKSubSystem)subsystem SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM(NSInteger, MMKLogLevel) {
  MMKLogLevelDebug = 0,
  MMKLogLevelInfo = 1,
  MMKLogLevelError = 2,
  MMKLogLevelFault = 3,
...
/// enum of potential logging levels.
typedef SWIFT_ENUM(NSInteger, MMKSubSystem) {
  MMKSubSystemEdgeSDK_iOS = 0,
  MMKSubSystemEdgeSDK_iOS_app_auth = 1,
  MMKSubSystemEdgeSDK_iOS_app_ops = 2,
  MMKSubSystemEdgeSDK_iOS_example = 3,
  MMKSubSystemEdgeSDK_iOS_access = 4,
  MMKSubSystemThird_party = 47,
};
